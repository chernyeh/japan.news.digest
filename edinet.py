...
# label rather than being silently dropped from the index. Kept short (badge
# and filter-pill display, not just internal bookkeeping) rather than fully
# spelled out — the filing's own title/description carries the detail.
EDINET_DOC_TYPES = {
    "010": "Securities Notice",
    "020": "Securities Notice (Amend)",
    "030": "Securities Registration",
    "040": "Securities Registration (Amend)",
    "050": "Registration Withdrawal",
    "060": "Issuance Notice",
    "070": "Shelf Registration",
    "080": "Issuance Registration",
    "090": "Issuance Registration (Amend)",
    "100": "Shelf Supplement",
    "110": "Issuance Withdrawal",
    "120": "Annual Report",
    "130": "Annual Report (Amend)",
    "135": "Confirmation Doc",
    "136": "Confirmation Doc (Amend)",
    "140": "Quarterly Report",
    "150": "Quarterly Report (Amend)",
    "160": "Semi-Annual Report",
    "170": "Semi-Annual Report (Amend)",
    "180": "Extraordinary Report",
    "190": "Extraordinary Report (Amend)",
    "200": "Parent Co. Status",
    "210": "Parent Co. Status (Amend)",
    "220": "Buyback Report",
    "230": "Buyback Report (Amend)",
    "235": "Internal Control",
    "236": "Internal Control (Amend)",
    "240": "Tender Offer Reg.",
    "250": "Tender Offer Reg. (Amend)",
    "260": "Tender Offer Withdrawal",
    "270": "Tender Offer Report",
    "280": "Tender Offer Report (Amend)",
    "290": "TOB Opinion",
    "300": "TOB Opinion (Amend)",
    "310": "TOB Q&A Response",
    "320": "TOB Q&A Response (Amend)",
    "330": "TOB Exemption",
    "340": "TOB Exemption (Amend)",
    "350": "Large Shareholding",
    "360": "Large Shareholding (Amend)",
    "370": "Shareholding Change",
    "380": "Shareholding Change (Amend)",
}

CSV_FIELDS = [
    "SecCode", "EdinetCode", "FilerName", "DocTypeCode", "DocDescription", "DocDescriptionEN",
...
def load_edinet_filings_from_github(repo: str, token: str = None) -> list:
    ...
    out = []
    for row in gh_read.raw_csv(repo, "data/edinet_filings.csv", token):
